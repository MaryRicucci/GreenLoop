...
$filename = "missione_".$idUtente."_".time()."".$ext ;
$filepath = $uploadDir.$filename;
if(!move_uploaded_file($foto["tmp-name"],$filepath)){
    echo json_encode([
        "success" => false ,
...
$fotoDB = "/uplads/missioni/".$filename;

$query = "SELECT punti from Missione WHERE id_Missione = ?";
//Prepare
//Assegna punti
